...
A simple REST API built with **Go**, created as a study project to learn Golang backend development. It exposes user management and authentication endpoints, backed by PostgreSQL, and is documented with [Bruno](https://www.usebruno.com/).
